<?php 
    ...
    try{
        ...
        $message = '<h3>Another admin has created an admin account for you.</h3><p>You can login at <a href="' . $login_url . '">' . $login_url . '</a> with the following information.</p><p>Username: <strong>' . $_POST['inputUsername'] . '</strong><br />Password: <strong>' . $_POST['inputPassword'] . '</strong></p>';
