    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <span class="help-block">Use this at the beginning of your content to set the post image header:<br /> <code>&lt;img class="headliner topbar-type" src="/assets/lol/whatever.png" /&gt;</code> <br />And be sure to change the "type" to the post category, like topbar-articles. If this is a comic, this should be the comic image and only content of the post.<br /><br />
